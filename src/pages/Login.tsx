    ...
    <Layout>
      <section className="py-16 flex items-center justify-center min-h-[70vh]">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">Log in to your DegreeTree account</p>

          <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="space-y-2">
              <Label htmlFor="email">Email</Label>
              <Input id="email" type="email" placeholder="firstname.lastname.year@mumail.ie" className="bg-muted border-border" value={email} onChange={(e) => setEmail(e.target.value)} required />
            </div>
            <div className="space-y-2">
