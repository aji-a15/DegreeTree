...
const modules: Module[] = [
  // Year 1
  {
    code: "CS161", name: "Introduction to Computer Science I", year: 1,
    ...
    feedsFrom: [], leadsTo: ["CS162", "CS210", "CS230"],
    careers: ["Software Developer", "Junior Programmer", "QA Tester"],
  },
  {
    code: "CS171", name: "Computer Systems I", year: 1,
    ...
    feedsFrom: [], leadsTo: ["CS172", "CS220", "CS265"],
    careers: ["IT Support Engineer", "Systems Analyst", "Technical Consultant"],
  },
  {
    code: "CS162", name: "Introduction to Computer Science II", year: 1,
    ...
    feedsFrom: ["CS161"], leadsTo: ["CS210", "CS211", "CS310"],
    careers: ["Software Engineer", "Backend Developer", "Algorithm Developer"],
  },
  {
    code: "CS172", name: "Computer Systems II", year: 1,
    ...
    feedsFrom: ["CS171"], leadsTo: ["CS355", "CS370", "CS357"],
    careers: ["Logic Designer", "Formal Methods Engineer", "Research Assistant"],
  },
  // Year 2
  {
    code: "CS210", name: "Algorithm And Data Structures 1", year: 2,
    ...
    feedsFrom: ["CS161", "CS162"], leadsTo: ["CS211", "CS264"],
    careers: ["Software Engineer", "Backend Developer", "Technical Interview Prep"],
  },
  {
    code: "CS220", name: "Computer Architecture", year: 2,
    ...
    feedsFrom: ["CS171"], leadsTo: ["CS433", "CS402"],
    careers: ["Hardware Engineer", "Embedded Systems Developer", "Chip Designer"],
  },
  {
    code: "CS211", name: "Algorithm And Data Structures 2", year: 2,
    ...
    feedsFrom: ["CS210", "CS162"], leadsTo: ["CS310", "CS401", "CS370"],
    careers: ["Software Engineer", "Data Engineer", "Competitive Programmer"],
  },
  {
    code: "CS240", name: "Operating Systems, Communication and Concurrency", year: 2,
    ...
    feedsFrom: ["CS171", "CS161"], leadsTo: ["CS320", "CS402"],
    careers: ["Systems Programmer", "DevOps Engineer", "Cloud Infrastructure Engineer"],
  },
  {
    code: "CS130", name: "Databases", year: 2,
    ...
    feedsFrom: ["CS161"], leadsTo: ["CS230", "CS264"],
    careers: ["Database Administrator", "Data Analyst", "Backend Developer"],
  },
  {
    code: "CS280", name: "Introduction to User Experience(UX), User Interface(UI) and Interaction Design", year: 2,
    ...
    feedsFrom: ["CS161"], leadsTo: ["CS423", "CS264"],
    careers: ["UX Designer", "UI Developer", "Product Designer", "Frontend Developer"],
  },
  {
    code: "CS335", name: "Software Engineering and Software Processing", year: 2,
    ...
    feedsFrom: ["CS161", "CS162"], leadsTo: ["CS264", "CS353"],
    careers: ["Software Engineer", "Project Manager", "Scrum Master"],
  },
  {
    code: "CS265", name: "Software Testing", year: 2,
    ...
    feedsFrom: ["CS171", "CS161"], leadsTo: ["CS357", "CS353"],
    careers: ["QA Engineer", "Test Automation Engineer", "Software Tester"],
  },
  {
    code: "CS355", name: "Theory of Computation", year: 2,
    ...
    feedsFrom: ["CS172"], leadsTo: ["CS370", "CS310", "CS424"],
    careers: ["Compiler Engineer", "Research Scientist", "Theoretical CS Researcher"],
  },
  {
  ...
  // Year 3
  {
    code: "CS370", name: "Computation and Complexity", year: 3,
    ...
    feedsFrom: ["CS355", "CS172", "CS211"], leadsTo: ["CS424", "MP472"],
    careers: ["Research Scientist", "Cryptographer", "Algorithm Researcher"],
  },
  {
    code: "CS320", name: "Computer Networks", year: 3,
    ...
    feedsFrom: ["CS240"], leadsTo: ["CS402", "CS416"],
    careers: ["Network Engineer", "Cloud Engineer", "Cybersecurity Analyst"],
  },
  {
    code: "CS310", name: "Programming Languages & Compilers", year: 3,
    ...
    feedsFrom: ["CS211", "CS355", "CS162"], leadsTo: ["CS424", "CS404"],
    careers: ["Compiler Engineer", "Language Designer", "Developer Tools Engineer"],
  },
  {
    code: "CS264", name: "Software Design", year: 3,
    ...
    feedsFrom: ["CS210", "CS335", "CS280", "CS130", "CS230"], leadsTo: ["CS353", "CS440"],
    careers: ["Software Architect", "Senior Developer", "Solutions Engineer"],
  },
  {
    code: "CS357", name: "Software Verification", year: 3,
    ...
    feedsFrom: ["CS172", "CS265"], leadsTo: ["CS424", "CS440"],
    careers: ["Formal Verification Engineer", "Safety-Critical Systems Developer", "Security Researcher"],
  },
  {
    code: "CS353", name: "Team Project", year: 3,
    ...
    feedsFrom: ["CS335", "CS265", "CS264", "CS230"], leadsTo: ["CS440"],
    careers: ["Software Developer", "Scrum Master", "Technical Lead", "DevOps Engineer"],
  },
  // Year 4
  {
    code: "CS433", name: "Advanced Computer Architecture", year: 4,
    ...
    feedsFrom: ["CS220"], leadsTo: [],
    careers: ["CPU Designer", "Embedded Systems Engineer", "Hardware Architect"],
  },
  {
    code: "CS430", name: "Advanced Concepts & Issues in Comp.Sci. 1", year: 4,
    ...
    feedsFrom: [], leadsTo: [],
    careers: ["Research Scientist", "Technology Consultant", "Academic Researcher"],
  },
  {
    code: "CS404", name: "Artificial Intelligence & Language Processing", year: 4,
    ...
    feedsFrom: ["CS310", "CS211"], leadsTo: [],
    careers: ["NLP Engineer", "AI Research Scientist", "Machine Learning Engineer"],
  },
  {
    code: "CS425", name: "Audio & Speech Processing", year: 4,
    ...
    feedsFrom: [], leadsTo: [],
    careers: ["Audio Engineer", "Speech Recognition Developer", "DSP Engineer"],
  },
  {
    code: "CS427", name: "Autonomous Mobile Robotics", year: 4,
    ...
    feedsFrom: ["CS422"], leadsTo: [],
    careers: ["Robotics Engineer", "Autonomous Systems Developer", "Perception Engineer"],
  },
  {
    code: "CS426", name: "Computer Graphics", year: 4,
    ...
    feedsFrom: [], leadsTo: [],
    careers: ["Graphics Programmer", "Game Developer", "Visual Effects Engineer"],
  },
  {
    code: "CS410", name: "Computer Vision", year: 4,
    ...
    feedsFrom: ["CS401"], leadsTo: [],
    careers: ["Computer Vision Engineer", "Autonomous Driving Engineer", "ML Engineer"],
  },
  {
    code: "CS416", name: "Cryptography", year: 4,
    ...
    feedsFrom: ["CS320", "CS172"], leadsTo: [],
    careers: ["Cryptographer", "Security Engineer", "Blockchain Developer"],
  },
  {
    code: "CS423", name: "Designing for Virtual Environments", year: 4,
    ...
    feedsFrom: ["CS280"], leadsTo: [],
    careers: ["XR Developer", "VR/AR Designer", "Game Designer", "3D Interaction Designer"],
  },
  {
    code: "CS440", name: "Final Year Project CSSE", year: 4,
    ...
    feedsFrom: ["CS353", "CS264", "CS357"], leadsTo: [],
    careers: ["Any CS Role", "Graduate Researcher", "Startup Founder"],
  },
  {
    code: "CS356", name: "Image and Optical Processing", year: 4,
    ...
    feedsFrom: [], leadsTo: [],
    careers: ["Image Processing Engineer", "Medical Imaging Specialist", "Computer Vision Engineer"],
  },
  {
    code: "CS401", name: "Machine Learning & Neural Networks", year: 4,
    ...
    feedsFrom: ["CS211"], leadsTo: ["CS410"],
    careers: ["Machine Learning Engineer", "Data Scientist", "AI Researcher"],
  },
  {
    code: "CS322", name: "Music Programming 2", year: 4,
    ...
    feedsFrom: [], leadsTo: [],
    careers: ["Audio Software Developer", "Music Tech Engineer", "Sound Designer"],
  },
  {
    code: "CS417", name: "Numerical Computation", year: 4,
    ...
    feedsFrom: [], leadsTo: [],
    careers: ["Quantitative Analyst", "Scientific Programmer", "Simulation Engineer"],
  },
  {
    code: "CS402", name: "Parallel & Distributed Systems", year: 4,
    ...
    feedsFrom: ["CS220", "CS240", "CS320"], leadsTo: [],
    careers: ["Cloud Architect", "Distributed Systems Engineer", "Site Reliability Engineer"],
  },
  {
    code: "CS424", name: "Programming Language Design & Semantics", year: 4,
    ...
    feedsFrom: ["CS310", "CS355", "CS370", "CS357"], leadsTo: [],
    careers: ["Language Designer", "Compiler Engineer", "PL Researcher"],
  },
  {
    code: "MP472", name: "Quantum Information Processing", year: 4,
    ...
    feedsFrom: ["CS370"], leadsTo: [],
    careers: ["Quantum Computing Researcher", "Quantum Software Developer", "Physics Researcher"],
  },
  {
    code: "CS422", name: "Robotics & Automation", year: 4,
    ...
    feedsFrom: [], leadsTo: ["CS427"],
    careers: ["Robotics Engineer", "Automation Engineer", "Control Systems Engineer"],
  },
];
